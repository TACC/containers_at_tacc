...
If you are not already, please login to the |machine| system, just like we did at the start of the previous section.  You should be on one of the login nodes of the system.
...
Create a file called "|pijobscript|" on the work filesystem:
